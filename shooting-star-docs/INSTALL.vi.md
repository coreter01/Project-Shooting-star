...
1. Tải file `.deb` mới nhất ở phần Releases.
2. Cài:
   ```bash
   ...
   ```
3. Mở app từ menu ứng dụng (tìm "Shooting Star") — không cần cài Python, không cần
...
Gỡ cài đặt: `sudo apt remove shooting-star` (hoặc tên gói tương ứng).
