...
async function handleAction(action) {
  ...
  if (action.type === "run_command") {
    addBubble(t("running", displayCmd), "system");
...
async function saveSettings() {
  ...
  for (const key of ["api_keys", "ollama_url", "ollama_model", "default_brain", "theme", "language", "background_image", "background_opacity", "glass_blur", "shortcuts"]) {
